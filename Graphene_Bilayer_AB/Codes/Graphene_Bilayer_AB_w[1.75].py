...
seeds = np.loadtxt('/home/dintomonjoy/Graphene_Bilayer_AB/Seeds.txt')
...
while counter < sample_number:
   ...
   # __________________
    ...
    while i<len(W):
        ...
        x[i]=tempo
        i=i+1
    np.savetxt('/home/dintomonjoy/AA_AB/Graphene_Bilayer_AB/Energy_Eigenvalues_w[1.75]/Energy_Eigenvalues'+str(counter)+'.txt',W.real,fmt='%.54e')
    #print(xt1)
    #print(xt2)
    #print(xt3)
    #print(xt4)
